...
def validate_username(request):
    ...
    with open("blog/static/user_drawing.png", 'wb') as f:
    	f.write(imgBase64)
    img1 = Image.open("blog/static/user_drawing.png")
    ...
    img1.save("blog/static/user_drawing.png")

    img = Image.open("blog/static/first_image.png")
